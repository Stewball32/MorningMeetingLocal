...
<div class="relative h-full w-full p-10">
	<Presentation options={{ history: true, transition: 'slide', controls: true, progress: true }}>
		<Slide class="w-full place-content-center place-items-center outline-blue-500 p-5 m-5 outline-8">
			<!-- <Paper /> -->
			<Slide animate class=" place-content-center place-items-center  outline-2">
				<p data-id="test" class="text-4xl font-bold drop-shadow-sm outline-8 outline-amber-500">Use arrow keys to navigate</p>
			</Slide>
			<Slide animate class="place-content-center place-items-center">
				<p class="text-6xl font-bold drop-shadow-sm">🪄</p>
				<p data-id="test" class="text-4xl font-bold drop-shadow-sm">Use arrow keys to navigate</p>
			</Slide>
		</Slide>
